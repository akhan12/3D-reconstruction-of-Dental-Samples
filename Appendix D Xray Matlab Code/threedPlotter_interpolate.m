function test= threedPlotter_interpolate( Points,file_name,numpoints)
...
ypoints_1=zeros(z,numpoints);
ypoints_2=zeros(z,numpoints);
xpoints2=zeros(z,numpoints);
...
Xray_Ply(xpoints,ypoints,file_name)
