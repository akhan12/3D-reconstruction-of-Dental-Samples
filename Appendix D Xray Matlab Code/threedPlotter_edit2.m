function test= threedPlotter_edit2( Points,file_name)
...
t1_t3=30;
t2=150;
halflvlpoints=((t1_t3*2)+t2)-2;
sz=halflvlpoints*z*2;
xpoints=zeros(z,halflvlpoints);
ypoints=zeros(z,halflvlpoints*2);
...
for i=1:z
    ...
    x_divisionpoints=linspace(Points(i,1,1),Points(i,1,2),numpoints);
    xpoints1=linspace(x_divisionpoints(1),x_divisionpoints(2),t1_t3);
    xpoints2=linspace(x_divisionpoints(2),x_divisionpoints(numpoints-1),t2);
    xpoints2(1)=[];
    xpoints3=linspace(x_divisionpoints(numpoints-1),x_divisionpoints(numpoints),t1_t3);
    xpoints3(1)=[];
    xpoints(i,:)=horzcat(xpoints1,xpoints2,xpoints3);
