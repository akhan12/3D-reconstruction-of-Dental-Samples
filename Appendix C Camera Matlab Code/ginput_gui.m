...
%   data from the selected rectangular box onto another plot. So that’s
...
%   doesn’t exist in this code, as inherently it simulates GINPUT for point
...
%   meaning user won’t need to activate it with any GUI component, but of
...
% 4.With minor tweaking, it’s possible to modify this framework to make it
